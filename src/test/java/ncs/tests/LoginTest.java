...
public class LoginTest extends RealDevice {
    ...
    public void checkAppStatus() throws Exception {
        ...
        driver.resetApp();
        signInPageDetails = loginPage.signInBtn();

    }


    /**
     * User is navigate to login Page
     */
    @Test
    public void login_Test0() {
        extentTest.info("checking the functionality of SignIn Button");
        Assert.assertEquals(signInPageDetails,"Enter your credentials to get in the app.");
    }
...
//
    ...
    public void login_Test4() {
        ...
        Assert.assertTrue(Generic.isElementPresent(driver,"//android.widget.TextView[contains(@text,'Please enter Email ID.')]"));
    ...
    public void login_Test5() {
        ...
        Assert.assertTrue(Generic.isElementPresent(driver,"//android.widget.TextView[contains(@text,'Please enter password')]"));
